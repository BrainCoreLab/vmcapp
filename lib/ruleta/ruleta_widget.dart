...
import 'ruleta_model.dart';
export 'ruleta_model.dart';
...
class _RuletaWidgetState extends State<RuletaWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RuletaModel());
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                            child: Text(
                                                              'Obtenga su oportunidad de ganar',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
                                                                  .override(
