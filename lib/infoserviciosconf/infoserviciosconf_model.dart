...
class InfoserviciosconfModel extends FlutterFlowModel {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - API (recargafinsus)] action in Button widget.
  ApiCallResponse? apiResult1y0;
