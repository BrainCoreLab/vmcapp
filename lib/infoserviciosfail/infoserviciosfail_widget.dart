...
import 'infoserviciosfail_model.dart';
export 'infoserviciosfail_model.dart';

class InfoserviciosfailWidget extends StatefulWidget {
  const InfoserviciosfailWidget({
    Key? key,
    this.slot,
    this.nmfinsus,
    this.vmcprice,
  ...
  @override
  _InfoserviciosfailWidgetState createState() =>
      _InfoserviciosfailWidgetState();
}

class _InfoserviciosfailWidgetState extends State<InfoserviciosfailWidget> {
  late InfoserviciosfailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InfoserviciosfailModel());
                                                              ...
                                                              Padding(
                                                                padding: EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        20.0),
                                                                child: Text(
                                                                  'NO HA COMPLETADO EL MONTO A DEPOSITAR',
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            5.0),
                                                                child: Text(
                                                                  'Complete el monto exacto a depositar',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodyMedium
                                                                      .override(
